...
Measured over the 20-transcript synthetic corpus in `src/eval/__fixtures__`. Regenerate with `bun run eval > docs/eval-baseline.md`; the output is deterministic, so a diff here means retrieval behavior changed.
...
| --------------------------- | ------- | -------- | -------- | ---- | ------------ | --------- | ------------- | ---------- |
| exact-error-string          | 5       | 100%     | 100%     | 1.00 | 4520         | 5746      | 1130          | 1437       |
| file-path                   | 5       | 100%     | 100%     | 1.00 | 750          | 933       | 188           | 233        |
| command                     | 5       | 100%     | 80%      | 0.90 | 2911         | 4215      | 728           | 1054       |
| multi-word-natural-language | 5       | 100%     | 80%      | 0.90 | 5512         | 6486      | 1378          | 1622       |
| scoped                      | 5       | 100%     | 100%     | 1.00 | 1511         | 2169      | 378           | 542        |
| negative                    | 5       | n/a      | n/a      | n/a  | 4528         | 5026      | 1132          | 1257       |
...
| ----------------------------- | --------------------------- | ---- | ----- | ------------------------------------ |
| err-stripe-signature          | exact-error-string          | 1    | 5746  | s01-stripe-webhook-signature         |
...
| cmd-docker-compose-postgres   | command                     | 1    | 4215  | s17-worker-postgres-split            |
| cmd-bun-test-filter           | command                     | 1    | 4175  | s18-invoice-rounding                 |
| cmd-gh-pr-release             | command                     | 1    | 2911  | s19-release-pr-automation            |
| nl-dunning-cron-to-queue      | multi-word-natural-language | 1    | 5512  | s06-dunning-queue-switch             |
| nl-webhook-signature-fix      | multi-word-natural-language | 2    | 5488  | s02-paddle-webhook-signature         |
| nl-worker-own-database        | multi-word-natural-language | 1    | 5979  | s17-worker-postgres-split            |
| nl-flaky-ci                   | multi-word-natural-language | 1    | 6486  | s12-flaky-ci-tests                   |
| nl-rate-limiting              | multi-word-natural-language | 1    | 5173  | s16-public-api-rate-limiting         |
...
| scoped-shared-postgres-pi     | scoped                      | 1    | 1511  | s17-worker-postgres-split            |
| scoped-terraform-infra        | scoped                      | 1    | 1378  | s11-terraform-rds-apply              |
| scoped-invoice-billing-worker | scoped                      | 1    | 1036  | s18-invoice-rounding                 |
...
| neg-swiftui       | swiftui navigation stack crash on ios 18                | 5       | 4528  | s08-subscription-undefined-typeerror |
| neg-knife         | how do I sharpen a chef knife properly                  | 5       | 4770  | s19-release-pr-automation            |
| neg-elasticsearch | elasticsearch cluster stuck yellow after a node restart | 5       | 5026  | s18-invoice-rounding                 |
